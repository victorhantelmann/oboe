...
object NativeInterface {
    ...
    fun addEffect(effect: Effect) {
        Log.d("INTERFACE", String.format("FXBoard %s added", effect.name))
    ...
    fun enableEffectAt(turnOn: Boolean, index: Int) {
        Log.d("INTERFACE", String.format("FXBoard %b at index %d", turnOn, index))
    ...
    fun removeEffectAt(index: Int) {
        Log.d("INTERFACE", String.format("FXBoard was removed at index %d", index))
        removeEffectNative(index)
    }

    // Rotates existing effect from index to another
    fun rotateEffectAt(from: Int, to: Int) {
        Log.d("INTERFACE", String.format("FXBoard was rotated from %d to %d", from, to))
